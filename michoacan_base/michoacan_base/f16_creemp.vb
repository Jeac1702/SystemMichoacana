Public Class f16_creemp
    ...
    Private Sub f16_creemp_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        ...
        pass = txtContra.Text
        Me.EmpleadoTableAdapter.añadirempleado(nom, ape, sex, tele, rfc, email, dir, pass)
